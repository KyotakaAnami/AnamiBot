...
await conn.fakeReply(m.chat, '*[❗] Ｌｏｄｉｎｇ．．．*', '0@s.whatsapp.net', 'Subscribe YT : •Anami', 'status@broadcast')
...
const fgif = {
  key: {
    ...
    ...{from: { remoteJid: "6282298512279-1621306547@g.us" }},
  },
  message: {
    videoMessage: {
      title: `ZEROBOT`,
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: 'Halo AnamiSatsu', //Kasih namalu
                            orderTitle: 'Subscribe YT •Anami',
...
const ftextt = {
	 key: { 
          fromMe: false,
	      participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "6282298512279-1621306547@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":"hallo bang",
...
const freply = {key:{ fromMe:false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: {
	...
	"productImageCount": 1
						...
						"businessOwnerJid": "6282298512279@s.whatsapp.net"}}}    
